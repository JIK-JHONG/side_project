...
import os
# import numpy as np
import capoo_finder as cf # 引入副程式中的函式
# print(dir(cf))  # 列出 Image_Processing 模組中的所有屬性

from PySide6.QtCore import Qt
from PySide6.QtGui import QPixmap, QImage, QStandardItem, QStandardItemModel
from PySide6.QtWidgets import QApplication, QWidget, QGraphicsScene, QGraphicsPixmapItem, QFileDialog, QHeaderView
...
class Widget(QWidget):
    def __init__(self, parent=None):
        ...
        self.ui.label_5.setText(str(60))
    ...
    def ImageView(self, img):
        ...
        self.ui.label_7.setText(str(result_summary["DogDog"]))
        self.ui.label_11.setText(str(result_summary["Capoo"]))
        self.ui.progressBar.setValue(100)
        self.ui.label_8.setText(str(elapsed_time))


    def update_image_profile(self, img):
        # 假設 image_analysis() 會返回 Matplotlib 的畫布 (FigureCanvas)
        fig = cf.image_analysis(img,"x")
