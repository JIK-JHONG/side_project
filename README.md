...
| [pgui_4ch_plot](https://github.com/JIK-JHONG/side_project/tree/main/pgui_4ch_plot/pgui_4ch_plot_V6.py) | python+tkinter | Automated analysis the experiment files(*.4ch) |
