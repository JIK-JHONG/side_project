...
public:
    ...
    QLabel *label;
    QSlider *Slider_Binary_Threshold;
    QLabel *Slider_Binary_Threshold_Val;
    QLabel *label_2;
    QSlider *Slider_Blur_Edge;
    QLabel *Slider_Blur_Edge_Val;
    QCheckBox *option_check_2;
    QSlider *Slider_Blur_Bks;
    QLabel *Slider_Blur_Bks_Val;
    QLabel *label_5;
    QGroupBox *groupBox_3;
    QCheckBox *option_check_binary;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setFont(font3);
        Slider_Binary_Threshold = new QSlider(groupBox_2);
        Slider_Binary_Threshold->setObjectName("Slider_screentone_size");
        Slider_Binary_Threshold->setGeometry(QRect(10, 40, 111, 25));
        Slider_Binary_Threshold->setOrientation(Qt::Orientation::Horizontal);
        Slider_Binary_Threshold_Val = new QLabel(groupBox_2);
        Slider_Binary_Threshold_Val->setObjectName("screenton_size");
        Slider_Binary_Threshold_Val->setGeometry(QRect(120, 40, 41, 20));
        Slider_Binary_Threshold_Val->setFont(font1);
        Slider_Binary_Threshold_Val->setAlignment(Qt::AlignmentFlag::AlignCenter);
        label_2 = new QLabel(groupBox_2);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(10, 70, 151, 16));
        label_2->setFont(font2);
        Slider_Blur_Edge = new QSlider(groupBox_2);
        Slider_Blur_Edge->setObjectName("Slider_screentone_gap");
        Slider_Blur_Edge->setGeometry(QRect(10, 90, 111, 25));
        Slider_Blur_Edge->setOrientation(Qt::Orientation::Horizontal);
        Slider_Blur_Edge_Val = new QLabel(groupBox_2);
        Slider_Blur_Edge_Val->setObjectName("screenton_gap");
        Slider_Blur_Edge_Val->setGeometry(QRect(120, 90, 41, 20));
        Slider_Blur_Edge_Val->setFont(font1);
        Slider_Blur_Edge_Val->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        Slider_Blur_Bks = new QSlider(groupBox_2);
        Slider_Blur_Bks->setObjectName("Slider_screentone_gap_2");
        Slider_Blur_Bks->setGeometry(QRect(10, 140, 111, 25));
        Slider_Blur_Bks->setOrientation(Qt::Orientation::Horizontal);
        Slider_Blur_Bks_Val = new QLabel(groupBox_2);
        Slider_Blur_Bks_Val->setObjectName("screenton_gap_2");
        Slider_Blur_Bks_Val->setGeometry(QRect(120, 140, 41, 20));
        Slider_Blur_Bks_Val->setFont(font1);
        Slider_Blur_Bks_Val->setAlignment(Qt::AlignmentFlag::AlignCenter);
        ...
        option_check_binary = new QCheckBox(groupBox_3);
        option_check_binary->setObjectName("option_check_3");
        option_check_binary->setGeometry(QRect(10, 30, 151, 20));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Slider_Binary_Threshold_Val->setText(QCoreApplication::translate("MainWindow", "1", nullptr));
        ...
        Slider_Blur_Edge_Val->setText(QCoreApplication::translate("MainWindow", "1", nullptr));
        option_check_2->setText(QCoreApplication::translate("MainWindow", "\345\217\215\345\220\221\351\201\270\345\217\226", nullptr));
        Slider_Blur_Bks_Val->setText(QCoreApplication::translate("MainWindow", "1", nullptr));
        ...
        option_check_binary->setText(QCoreApplication::translate("MainWindow", "\351\241\257\347\244\272\344\272\214\351\232\216\350\231\225\347\220\206\351\201\216\347\250\213", nullptr));
